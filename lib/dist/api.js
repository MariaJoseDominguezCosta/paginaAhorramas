...
exports.getStrapiMedia = exports.fetchAPI = void 0;
...
function fetchAPI(path, query) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = STRAPI_URL + "/api/" + path + (query ? "?" + query : "");
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("Error al conectar con la API de Strapi: " + response.statusText);
                    }
