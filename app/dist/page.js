...
var FacebookIcon = function (props) { return (react_1["default"].createElement("svg", __assign({ viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, props),
...
var InstagramIcon = function (props) { return (react_1["default"].createElement("svg", __assign({ viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, props),
    ...
    react_1["default"].createElement("line", { x1: "17.5", x2: "17.51", y1: "6.5", y2: "6.5" }))); };
// Icono personalizado de WhatsApp (SVG directo de marca)
var WhatsAppIcon = function (props) { return (react_1["default"].createElement("svg", __assign({ viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, props),
...
function HomePage() {
    ...
    return (react_1["default"].createElement("div", { className: "bg-[#FAFAFA] min-h-screen text-[#1A1A1A] font-sans antialiased" },
        react_1["default"].createElement("div", { className: "bg-[#CE2C3C] text-white text-[11px] md:text-[13px] font-medium text-center py-2 px-4 tracking-wide" }, "Descuento adicional en tu primera compra mayor a $10,000 | Garant\u00EDa por defecto de fabrica | Soporte en l\u00EDnea"),
        ...
        react_1["default"].createElement("section", { className: "max-w-7xl mx-auto px-6 mt-12 mb-20 min-h-[400px]" },
            ...
            filteredProducts.length === 0 ? (react_1["default"].createElement("div", { className: "text-center py-16 text-zinc-500" }, "No se encontraron muebles que coincidan con tu b\u00FAsqueda.")) : (react_1["default"].createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4" }, filteredProducts.map(function (item) { return (react_1["default"].createElement("div", { key: "search-" + item.id, className: "bg-white border border-[#E4E4E7] rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md hover:border-[#CE2C3C]" },
                ...
                react_1["default"].createElement("div", { className: "p-4" },
                    ...
                    react_1["default"].createElement(link_1["default"], { href: "/producto/" + item.id, className: "block w-full bg-[#CE2C3C] text-white text-xs font-bold py-2.5 rounded-md text-center hover:bg-[#A8202D] transition" }, "Ver producto")))); }))))) : (
        ...
        react_1["default"].createElement(react_1["default"].Fragment, null,
            ...
            react_1["default"].createElement("section", { className: "max-w-7xl mx-auto px-6 mt-12" },
                ...
                react_1["default"].createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4" }, products.slice(0, 4).map(function (item) { return (react_1["default"].createElement("div", { key: "nuevo-" + item.id, className: "bg-white border border-[#E4E4E7] rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md hover:border-[#CE2C3C]" },
                    react_1["default"].createElement("div", { className: "bg-[#F4F4F5] h-40 flex items-center justify-center relative overflow-hidden" },
            ...
            react_1["default"].createElement("section", { className: "max-w-7xl mx-auto px-6 mt-12" },
                ...
                react_1["default"].createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4" }, products.slice(0, 4).map(function (item) { return (react_1["default"].createElement("div", { key: "fav-" + item.id, className: "bg-white border border-[#E4E4E7] rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md hover:border-[#CE2C3C]" },
            ...
            react_1["default"].createElement("section", { className: "max-w-7xl mx-auto px-6 mt-12" },
                ...
                react_1["default"].createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4" }, products.slice(0, 4).map(function (item) { return (react_1["default"].createElement("div", { key: "oferta-" + item.id, className: "bg-white border border-[#E4E4E7] rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md hover:border-[#CE2C3C]" },
                    react_1["default"].createElement("div", { className: "bg-[#F4F4F5] h-40 flex items-center justify-center relative overflow-hidden" },
            ...
            react_1["default"].createElement("section", { className: "max-w-7xl mx-auto px-6 mt-12 mb-16" },
                ...
                react_1["default"].createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4" }, products.slice(0, 4).map(function (item) { return (react_1["default"].createElement("div", { key: "destacado-" + item.id, className: "bg-white border border-[#E4E4E7] rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md hover:border-[#CE2C3C]" },
                    react_1["default"].createElement("div", { className: "bg-[#F4F4F5] h-40 flex items-center justify-center relative overflow-hidden" },
                        react_1["default"].createElement("span", { className: "absolute top-2 left-2 bg-red-100 text-red-700 text-[10px] font-bold px-2 py-0.5 rounded-full z-10" }, item.badge_oferta || "Oferta 30%"),
                        react_1["default"].createElement("span", { className: "absolute bottom-2 right-2 bg-[#FDE8EA] text-[#A8202D] text-[9px] font-bold px-2 py-0.5 rounded-full tracking-wider uppercase z-10" }, item.tipo_oferta || "Hot Sale"),
                        item.imagenUrl ? (react_1["default"].createElement("img", { src: item.imagenUrl, alt: item.nombre, className: "w-full h-full object-contain p-4 transition-transform duration-300 hover:scale-105" })) : (react_1["default"].createElement("span", { className: "text-5xl opacity-80" }, item.foto_icono))),
                    react_1["default"].createElement("div", { className: "p-4" },
                        ...
                        react_1["default"].createElement("h4", { className: "font-bold text-sm text-[#1A1A1A] mt-1 mb-4 h-10 line-clamp-2" }, item.nombre),
                        react_1["default"].createElement(link_1["default"], { href: "/producto/" + item.id, className: "block w-full bg-[#CE2C3C] text-white text-xs font-bold py-2.5 rounded-md text-center hover:bg-[#A8202D] transition" }, "Ver producto")))); }))))),
        react_1["default"].createElement("section", { className: "bg-white border-t border-b border-[#E4E4E7] py-8" },
            react_1["default"].createElement("div", { className: "max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6" },
                react_1["default"].createElement("div", { className: "flex items-center gap-3" },
                    react_1["default"].createElement("div", { className: "p-3 bg-red-50 text-[#CE2C3C] rounded-lg" },
                        react_1["default"].createElement(lucide_react_1.Truck, { className: "w-5 h-5" })),
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("strong", { className: "text-xs md:text-sm block" }, "ENV\u00CDO A DOMICILIO"),
                        react_1["default"].createElement("span", { className: "text-[11px] md:text-xs text-[#626264]" }, "A ciudades de Chiapas y Tabasco *"))),
                react_1["default"].createElement("div", { className: "flex items-center gap-3" },
                    react_1["default"].createElement("div", { className: "p-3 bg-red-50 text-[#CE2C3C] rounded-lg" },
                        react_1["default"].createElement(lucide_react_1.PhoneCall, { className: "w-5 h-5" })),
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("strong", { className: "text-xs md:text-sm block" }, "CONTACTANOS"),
                        react_1["default"].createElement("span", { className: "text-[11px] md:text-xs text-[#626264]" }, "Soporte en l\u00EDnea directo"))),
                react_1["default"].createElement("div", { className: "flex items-center gap-3" },
                    react_1["default"].createElement("div", { className: "p-3 bg-red-50 text-[#CE2C3C] rounded-lg" },
                        react_1["default"].createElement(lucide_react_1.Percent, { className: "w-5 h-5" })),
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("strong", { className: "text-xs md:text-sm block" }, "DESCUENTOS"),
                        react_1["default"].createElement("span", { className: "text-[11px] md:text-xs text-[#626264]" }, "En \u00F3rdenes mayores a $10,000 [5, 12]"))),
                react_1["default"].createElement("div", { className: "flex items-center gap-3" },
                    react_1["default"].createElement("div", { className: "trust-icon bg-red-50 rounded-lg p-2.5 text-[#CE2C3C]" },
                        react_1["default"].createElement(lucide_react_1.Medal, { className: "w-5 h-5" })),
                    react_1["default"].createElement("div", { className: "trust-text" },
                        react_1["default"].createElement("strong", { className: "block text-sm font-semibold text-[#1A1A1A]" }, "GARANTIA"),
                        react_1["default"].createElement("span", { className: "text-[11px] md:text-xs text-[#626264]" }, "6 meses por defecto de f\u00E1brica [12]"))))),
        react_1["default"].createElement(Newsletter_1["default"], null),
        react_1["default"].createElement("footer", { className: "bg-[#18181B] text-zinc-400 py-12 text-[13px] border-b border-zinc-800" },
            react_1["default"].createElement("div", { className: "max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8" },
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("div", { className: "font-extrabold text-lg text-white mb-4" },
                        react_1["default"].createElement("img", { src: "/images/logo.png", alt: "Muebler\u00EDas Ahorram\u00E1s", className: "h-12 w-auto object-contain" })),
                    react_1["default"].createElement("p", { className: "line-clamp-4 leading-relaxed mb-6" }, "La cadena de muebler\u00EDas n\u00FAmero 1 en Chiapas y Tabasco. Calidad y elegancia a precios inigualables desde 2003."),
                    react_1["default"].createElement("div", { className: "flex gap-2" },
                        react_1["default"].createElement("span", { className: "w-8 h-8 rounded-md bg-zinc-800 flex items-center justify-center hover:bg-[#CE2C3C] hover:text-white cursor-pointer transition" },
                            react_1["default"].createElement(FacebookIcon, { className: "w-4 h-4" })),
                        react_1["default"].createElement("span", { className: "w-8 h-8 rounded-md bg-zinc-800 flex items-center justify-center hover:bg-[#CE2C3C] hover:text-white cursor-pointer transition" },
                            react_1["default"].createElement(InstagramIcon, { className: "w-4 h-4" })),
                        react_1["default"].createElement("span", { className: "w-8 h-8 rounded-md bg-zinc-800 flex items-center justify-center hover:bg-[#CE2C3C] hover:text-white cursor-pointer transition" },
                            react_1["default"].createElement(WhatsAppIcon, { className: "w-4 h-4" })))),
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("h5", { className: "font-bold text-white mb-4" }, "Categor\u00EDas"),
                    react_1["default"].createElement("ul", { className: "space-y-2" },
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/salas", className: "hover:text-white" }, "Salas")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/recamaras", className: "hover:text-white" }, "Rec\u00E1maras")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/comedores", className: "hover:text-white" }, "Comedores")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/tv", className: "hover:text-white" }, "Muebles TV")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/colchones", className: "hover:text-white" }, "Colchones")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/otrosMuebles", className: "hover:text-white" }, "Otros muebles")))),
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("h5", { className: "font-bold text-white mb-4" }, "Empresa"),
                    react_1["default"].createElement("ul", { className: "space-y-2" },
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/nosotros", className: "hover:text-white" }, "Sobre nosotros")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/sucursales", className: "hover:text-white" }, "Sucursales")),
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/privacidad", className: "hover:text-white" }, "Pol\u00EDtica de privacidad")))),
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("h5", { className: "font-bold text-white mb-4" }, "Contacto"),
                    react_1["default"].createElement("p", { className: "mb-2" }, "\uD83D\uDCDE 9632684589"),
                    react_1["default"].createElement("p", { className: "mb-2" }, "\uD83D\uDCCD Las Margaritas, Chiapas, M\u00E9xico"),
                    react_1["default"].createElement("p", null, "\u2709\uFE0F info@muebleriasahorramas.com.mx")))),
        react_1["default"].createElement("div", { className: "bg-[#0F0F10] text-[11px] text-zinc-600 py-4 text-center" }, "Copyright \u00A9 2003 Muebler\u00EDas Ahorra Mas. Todos los derechos reservados.")));
}
