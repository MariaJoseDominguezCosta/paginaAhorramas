...
export interface ApiBannerHomeBannerHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imagen_banner: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required;
    link_destino: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMuebleMueble extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    precio_lista_tapachula: Schema.Attribute.Decimal;
    precio_oferta_chiapas: Schema.Attribute.Decimal;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variantes: Schema.Attribute.Component<'muebles.variante-color', true>;
  };
}
...
export interface ApiTelaTela extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    archivo_textura: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tela.tela'> &
      Schema.Attribute.Private;
    material: Schema.Attribute.Relation<'oneToOne', 'api::material.material'>;
    nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    tipo_aplicacion: Schema.Attribute.Enumeration<['Base', 'Frente', 'Ambos']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
